...
public class Type2 extends Type{
	 ...
	 * 
	 * INPUT format --> Type2;BuyItemA;SavePrice;mdsFam1,mdsFam2,mdsFamN;Quantity
	 * */
	public Type2(String[] inputs) {
	...
	public String getOfferName() {
		return "Buy "+quantity+" Save £"+price;
	}
	...
	public Type2(String lstype,String price,String skus,String qty) {
		setOfferType(lstype);
		setBuyA("A");
		setPrice(price);
		setQuantity(qty);
